...
class AppTest {
    ...
    void testReversedSequence() {
        CharSequence text = new ReversedSequence("Hello, World!");
        String exp1 = "!dlroW ,olleH";
        char exp2 = 'W';
        int exp3 = 13;
        String exp4 = "dlr";
        assertThat(text.toString()).isEqualTo(exp1);
        assertThat(text.charAt(5)).isEqualTo(exp2);
        assertThat(text.length()).isEqualTo(exp3);
        assertThat(text.subSequence(1,4).toString()).isEqualTo(exp4);
    }
    // END
}
